    ...
    <DropdownMenuPrimitive.Portal>
      ...
      >
        <DropdownMenuPrimitive.Popup
          ...
          className={cn(
            "bg-popover text-popover-foreground z-50 min-w-[8rem] origin-(--transform-origin) overflow-hidden rounded-md border p-1 shadow-lg outline-none transition-[transform,scale,opacity] data-[starting-style]:scale-95 data-[starting-style]:opacity-0 data-[ending-style]:scale-95 data-[ending-style]:opacity-0",
            className
          )}
          {...props}
        />
